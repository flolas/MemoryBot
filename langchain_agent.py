...
def get_langchain_agent(df, open_api_key):
    ...
    user_brief = f'''Te escribirá {user['username']}, tiene una renta mensual de ${user['income_median']}, además todos los meses paga ${user['loan_monthly_payments_median']} en créditos. 
